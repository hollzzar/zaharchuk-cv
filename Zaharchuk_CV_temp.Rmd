...
## Chunk set to eval=FALSE
## I wanted to keep the code I wrote to pull my pubs from Google Scholar, 
## but I prefer to update them manually in BibDesk
## Google Scholar entries aren't totally correct, so I have to edit the entries
## a lot anyway
