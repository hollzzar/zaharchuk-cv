...
Cognitive Science Society}}. Curran Associates.
...
\leavevmode\hypertarget{ref-1}{}%
\textbf{\textbf{Zaharchuk, H.} A.} (2015). \emph{\emph{Does linguistic experience change
...
\textbf{\textbf{Zaharchuk, H.} A.}, Shevlin, A., \& Van Hell, J. G. (2020). \emph{\emph{We
{``might could''} revisit syntactic processing: Studying dialectal
variation with event-related potentials}}. Poster session to be
...
\textbf{\textbf{Zaharchuk, H.} A.}, Shevlin, A., \& Van Hell, J. G. (2019).
\emph{\emph{Auditory comprehension of double versus single modal
constructions in {M}ainstream {A}merican {E}nglish listeners}}. Poster
session presented at the {60th Annual Meeting of the Psychonomic
Society, Montr{é}al, Qu{é}bec, Canada}.
...
\item Created and solicited content for the \href{https://sites.psu.edu/bilingualismmatters/}{\underline{Winter/Spring 2020 Bilingualism Matters newsletter}}
\end{cvitems}}
\end{cventries}
