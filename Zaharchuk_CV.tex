...
include phonetic and syntactic variation, code-switching, and network
models of language.
...
(2021, August). \emph{The role of dialect expectation on lexical
processing: EEG evidence}. Talk presented at the {5th Variation and
Language Processing Conference (VALP5), Copenhagen, Denmark}.
